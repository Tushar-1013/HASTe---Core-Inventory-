...
const kpis = [
    { title: "Total Products", value: 248, icon: Package, subtitle: "+12 this week", trend: "up" },
    { title: "Low Stock Items", value: 14, icon: AlertTriangle, subtitle: "3 out of stock", trend: "down" },
    ...
    return (<div>
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {["All", "Receipts", "Delivery"].map((f) => (<button key={f} className="px-3 py-1.5 text-xs font-medium rounded-md bg-secondary text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors first:bg-primary first:text-primary-foreground">
              {f}
            </button>))}
        </div>
      </div>
