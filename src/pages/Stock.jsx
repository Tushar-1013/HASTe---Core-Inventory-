...
export default function Stock() {
    ...
    return (<div>
      ...
      <div className="flex items-center gap-2 bg-secondary rounded-md px-3 py-2 max-w-sm mb-6">
        ...
        <input type="text" placeholder="Search products..." value={search} onChange={(e) => setSearch(e.target.value)} className="bg-transparent text-sm outline-none w-full placeholder:text-muted-foreground"/>
      </div>
